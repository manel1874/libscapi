...
//*/
//
//#include "../include/mid_layer/Paillier.hpp"
//
////
////void PaillierAPI::init_rand(gmp_randstate_t rand, paillier_get_rand_t get_rand, int bytes)
////{
////	void* buf;
////	//mpz_t s;
////	biginteger s;
...
////}
//
//void PaillierAPI::complete_pubkey(paillier_pubkey_t* pub )
//{
//	pub->n_squared = pub->n * pub->n;
//	pub->n_plusone = pub->n + 1;
//	pub->g = new NTL::ZZ[sizeof(NTL::ZZ)*NumberOfBits(pub->n_plusone)];
//	auto N = convertMpztoZZ(pub->n_plusone);
//	NTLWrapper ntlWrapper;
//	ntlWrapper.init(N, N, 2560);
//	ntlWrapper.getGenerators(pub->g, 2560);
//	
//	//mpz_mul(pub->n_squared, pub->n, pub->n);
//	//mpz_add_ui(pub->n_plusone, pub->n, 1);
//	//pub->g = new NTL::ZZ[sizeof(NTL::ZZ)*mpz_sizeinbase(pub->n_plusone, 2)];
//	//NTL::ZZ N = convertMpztoZZ(pub->n_plusone);
//	//NTLWrapper ntlWrapper;
//	//ntlWrapper.init(N,N,2560);
//	//ntlWrapper.getGenerators(pub->g,2560);
//}
//
//void PaillierAPI::complete_prvkey(paillier_prvkey_t* prv, paillier_pubkey_t* pub)
//{
//	prv->x = mp::powm(pub->n_plusone, prv->lambda, pub->n_squared);
//	prv->x -= 1;
//	prv->x /= pub->n;
//	prv->x = MathAlgorithms::modInverse(prv->x, pub->n);
...
//}
//
//void PaillierAPI::paillier_keygen( int modulusbits,
...
//}
//
//paillier_ciphertext_t* PaillierAPI::paillier_enc( paillier_ciphertext_t* res,
//							paillier_pubkey_t* pub,
...
//	//MPZPrecomputeExp_Sec p
//	// p.init(pub->n_plusone,pub->n_squared)
//	// p.prepExpTableSpecifyBitLength(bits)
//	// -----------------------------------------
//	// p.compExp(res->c,pt->m)
...
//}
//
//paillier_plaintext_t* PaillierAPI::paillier_dec( paillier_plaintext_t* res,
//							paillier_pubkey_t* pub,
//							paillier_prvkey_t* prv,
...
//}
//
//void PaillierAPI::paillier_mul( paillier_pubkey_t* pub,
...
//}
//
//void PaillierAPI::paillier_exp( paillier_pubkey_t* pub,
//							paillier_ciphertext_t* res,
//							paillier_ciphertext_t* ct,
//							paillier_plaintext_t* pt )
//{
...
//}
//
//paillier_plaintext_t* PaillierAPI::paillier_plaintext_from_bytes( void* m, int len )
//{
//	paillier_plaintext_t* pt;
//
//	pt = (paillier_plaintext_t*) malloc(sizeof(paillier_plaintext_t));
...
//}
//
//void* PaillierAPI::paillier_plaintext_to_bytes( int len,
//														 paillier_plaintext_t* pt )
//{
//	void* buf0;
//	void* buf1;
...
//}
//
//paillier_plaintext_t* PaillierAPI::paillier_plaintext_from_str( char* str )
//{
//	return paillier_plaintext_from_bytes(str, strlen(str));
//}
//
//char* PaillierAPI::paillier_plaintext_to_str( paillier_plaintext_t* pt )
//{
//	char* buf;
//	size_t len;
//
...
//}
//
//paillier_ciphertext_t* PaillierAPI::paillier_ciphertext_from_bytes( void* c, int len )
//{
//	paillier_ciphertext_t* ct;
//
...
//}
//
//void* PaillierAPI::paillier_ciphertext_to_bytes( int len,
//															paillier_ciphertext_t* ct )
//{
//	void* buf;
//	int cur_len;
...
//}
//
//char* PaillierAPI::paillier_pubkey_to_hex( paillier_pubkey_t* pub )
//{
...
//}
//
//paillier_pubkey_t* PaillierAPI::paillier_pubkey_from_hex( char* str )
//{
//	paillier_pubkey_t* pub;
//
//	pub = (paillier_pubkey_t*) malloc(sizeof(paillier_pubkey_t));
...
//}
//
//paillier_prvkey_t* PaillierAPI::paillier_prvkey_from_hex( char* str, paillier_pubkey_t* pub )
//{
//	paillier_prvkey_t* prv;
//
//	prv = (paillier_prvkey_t*) malloc(sizeof(paillier_prvkey_t));
...
//}
//
//void PaillierAPI::paillier_freepubkey( paillier_pubkey_t* pub )
//{
//	mpz_clear(pub->n);
...
//}
//
//void PaillierAPI::paillier_freeprvkey( paillier_prvkey_t* prv )
//{
...
//}
//
//void PaillierAPI::paillier_freeplaintext( paillier_plaintext_t* pt )
//{
//	mpz_clear(pt->m);
//	free(pt);
//}
//
//void PaillierAPI::paillier_freeciphertext( paillier_ciphertext_t* ct )
//{
//	mpz_clear(ct->c);
//	free(ct);
//}
//
//void PaillierAPI::paillier_get_rand_file( void* buf, int len, char* file )
//{
//	FILE* fp;
//	void* p;
//
...
//}
//
//void PaillierAPI::paillier_get_rand_devrandom( void* buf, int len )
//{
//	paillier_get_rand_file(buf, len, "/dev/random");
//}
//
//void PaillierAPI::paillier_get_rand_devurandom( void* buf, int len )
//{
//	paillier_get_rand_file(buf, len, "/dev/urandom");
//}
//
//paillier_ciphertext_t* PaillierAPI::paillier_create_enc_zero()
//{
//	paillier_ciphertext_t* ct;
//
...
//}
//
//void PaillierAPI::convertZZtoMpz(ZZ zz,mpz_t &p)
//{
//	std::stringstream ssa;
//	ssa << zz;
//	mpz_set_str(p, ssa.str().c_str(),10);
//}
//
//ZZ PaillierAPI::convertMpztoZZ(mpz_t &p)
//{
//	//zz(NTL::INIT_VAL, mpz_get_str(NULL,10,p));
// 	NTL::ZZ number (NTL::INIT_VAL, mpz_get_str(NULL,10,p));
// 	return number;
//}
