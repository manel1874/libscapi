...
- ## License information
Libscapi is released under the MIT open source license. However, some of the libraries we use have different licenses. For further information pleare refer to [LICENSE.MD](build-scripts/LICENSE.MD)
...
For detailed instructions, see [INSTALL.MD](build-scripts/INSTALL.MD)
