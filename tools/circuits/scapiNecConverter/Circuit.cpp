    ...
    if (myfile.is_open())
    {
        ...
        for (int j = 0; j<numberOfParties; j++) {
            ...
            for (int i = 0; i<numOfInputsForEachParty[currentPartyNumber - 1]; i++) {
                ...
                if (partiesInputs[currentPartyNumber - 1][i] > maxWireIndex){
                    maxWireIndex = partiesInputs[currentPartyNumber - 1][i];
                }
            }
        }
        ...
        for (int j = 0; j<numberOfParties; j++) {
            ...
            for (int i = 0; i<numOfOutputsForEachParty[currentPartyNumber - 1]; i++) {
                ...
                if (partiesOutputs[currentPartyNumber - 1][i] > maxWireIndex){
                    maxWireIndex = partiesOutputs[currentPartyNumber - 1][i];
                }
            }
        }
        ...
        for (int i = 0; i<numberOfGates; i++)
        {
            ...
            if (gates[i].outputIndex > maxWireIndex){
                maxWireIndex = gates[i].outputIndex;
            }
